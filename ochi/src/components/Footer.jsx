    ...
    <div className="w-full h-screen bg-zinc-900 p-20 flex  ">
      <div className="w-1/2 h-full flex flex-col justify-between font-semibold">
        <div className="heading">
          <h1 className="uppercase text-[6vw] leading-none tracking-tighter">
            Eye-
          </h1>
          <h1 className="uppercase text-[6vw] leading-none tracking-tighter">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="uppercase text-[5vw] font-semibold leading-none tracking-tighter">
          Presentations
        </h1>
      </div>
    </div>
